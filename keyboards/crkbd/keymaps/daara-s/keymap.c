...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX,LALT_T(KC_A),LCTL_T(KC_R),LGUI_T(KC_S),LSFT_T(KC_T), KC_G,        KC_M,RSFT_T(KC_N),LGUI_T(KC_E),LCTL_T(KC_I),LALT_T(KC_O),XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, KC_LALT, KC_LCTL, KC_LGUI, KC_LSFT, XXXXXXX,                      XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|--------|
      XXXXXXX, KC_LALT, KC_LCTL, KC_LGUI, KC_LSFT, XXXXXXX,                      KC_MINS,    KC_4,    KC_5,    KC_6, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|--------|
  ...
  //|--------+--------+--------+--------+--------|--------+                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, KC_SCLN, KC_LPRN, KC_RPRN, KC_GRAVE,                     XXXXXXX, KC_RSFT, KC_LGUI, KC_LCTL, KC_LALT, XXXXXXX,
  //|--------+--------+--------+--------+--------|--------+                    |--------+--------+--------+--------+--------+--------|
